"""Training script for SimCLR contrastive learning on STL-10."""
...
# Allow running as `python scripts/train_simclr.py` from project root
sys.path.insert(0, str(Path(__file__).resolve().parents[1]))

from evaluation.knn import knn_accuracy
from models.simclr import SimCLR, SimCLRAugmentation, nt_xent_loss
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train SimCLR on STL-10")
    # Model
    ...
    # Logging & checkpoints
    parser.add_argument("--log-dir", type=str, default="results/simclr")
...
def main():
    ...
    # -- Data --
    # SimCLR augmentation returns (view1, view2) per image
    ...
    # Eval uses standard normalized transform (matches SimCLR's training normalization)
    ...
    if args.wandb:
        ...
        wandb.init(
            ...
            name=args.wandb_run_name or "simclr",
            config=vars(args),
        )
